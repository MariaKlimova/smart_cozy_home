...
export const copy = {
  ...
  scenarios: {
    ...
    settingsFields: {
      ...
      playlist: 'Плейлист',
      playlistHint: 'Пусто — без музыки. Алиса скажет «включи плейлист …»',
      playlistPlaceholder: 'Например: вечерний джаз',
  ...
  sleep: {
    ...
    wearableScoreBreakdownTitle: 'Из чего складывается',
