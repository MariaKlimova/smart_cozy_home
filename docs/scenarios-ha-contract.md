...
**Калибровка устройства (не сценарий):** `input_number.bedroom_light_visible_min` (0, max 99) — порог «свет виден с». Логические % слайдера и `*_brightness` пересчитываются в железо `[min, 100]` в scripts и в приложении (`HA_ENTITIES.devices.lightVisibleMin`).
