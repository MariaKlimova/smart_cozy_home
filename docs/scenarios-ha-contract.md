...
| **sleep** | `input_number.sleep_temperature` (17), `input_boolean.sleep_window` (false), `input_boolean.sleep_nightlight` (true), `input_number.sleep_nightlight_brightness` (8) |
